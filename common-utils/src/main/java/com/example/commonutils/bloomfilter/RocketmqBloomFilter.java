...
package com.example.commonutils.bloomfilter;
 ...
 */
public class RocketmqBloomFilter {
     ...
     */
    public static RocketmqBloomFilter createByFn(int f, int n) {
        return new RocketmqBloomFilter(f, n);
    }
     ...
     * @param n num will mapping to bit
     */
    public RocketmqBloomFilter(int f, int n) {
        if (f < 1 || f >= 100) {
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof RocketmqBloomFilter))
            return false;

        RocketmqBloomFilter that = (RocketmqBloomFilter) o;
