...
import com.ruyuan.cloud.excel.enums.ExcelTypeEnum;
...
public class ExcelTemplateImpl implements ExcelTemplate {
     ...
     */
    @Override
    public void exportExcel(List<?> list, String title, String sheetName, Class<?> pojoClass,
    ...
    private static void downLoadExcel(String fileName, HttpServletResponse response, Workbook workbook) throws IOException {
        try {
            // 通过http response响应对象，把数据通过response输出出去
            // 提供给我们的浏览器来进行下载
     ...
     */
    @Override
    public <T> List<T> importExcel(MultipartFile file, Integer titleRows, Integer headerRows, boolean needVerify, Class<T> pojoClass) throws IOException {
        if (file == null) {
            return null;
        }
        try {
